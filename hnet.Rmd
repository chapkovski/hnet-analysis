...
This data was downloaded from <https://www.h-net.org/jobs> and parsed into a relational database using Python and Django. Parser is available [here]() and the most recent version of the database is available [here](https://osf.io/3sb52/). In total for the last 20 years (starting from 2000 till December 31, 2020) a bit more than 38.000 job ads were posted at H-Net: on average about 1800 position per year.
...
polar_graph<-  full_join(byweek,averages) %>%
  ...
  scale_colour_manual(name = element_blank(),
         values =c('blue'='blue','red'='red', 'lightgray'='lightgray'), labels = c('Average 2001-2019','Specific years 2001-2019', '2020'))+guides(size=F)+
  theme_bw()+
